...
class UtilityTest extends UnitTest
{
     ...
     */
    function postingListCodingTestCase()
    {
        $posting_list = array(90, 101, 570, 581, 737, 950, 1100, 1119, 1127,
            ...
            6976);
        $packed = packPosting(10, $posting_list);
        $offset = 0;
        $out_doc_list = unpackPosting($packed, $offset, true);
        ...
        $posting_list = array(6000, 12000, 24000);
        $packed = packPosting(100000, $posting_list);
        $offset = 0;
        $out_doc_list = unpackPosting($packed, $offset, true);
